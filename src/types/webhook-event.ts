import type { PackageType, PackageCondition } from './package.js';
...
export interface PackageReceivedPayload {
  ...
  /** Present on events from api-courier ≥ 2026-04-24. */
  ...
  /** Air / Sea — present on events from api-courier ≥ 2026-04-24. */
  freightType?: 'Air' | 'Sea';
